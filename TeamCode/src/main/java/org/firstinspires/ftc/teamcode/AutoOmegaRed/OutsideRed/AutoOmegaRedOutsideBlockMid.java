package org.firstinspires.ftc.teamcode.AutoOmegaRed.OutsideRed;
...
@Autonomous(name = "Auto Drive Red (outside park, block mid)", group = "Autonomous")
//@Disabled
public class AutoOmegaRedOutsideBlockMid extends LinearOpMode {
